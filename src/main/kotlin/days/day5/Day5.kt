...
class Day5 : Day {
    ...
    fun getRules(s: String): List<Pair<Int, Int>> =
    ...
    fun correctlyOrderAWrongLine(
        ...
        newLine[aIndex] = b
        newLine[bIndex] = a
        if (doesLineObeyRules(newLine, rules)) {
            return newLine
        } else {
            return correctlyOrderAWrongLine(newLine.toList(), rules)
        }
    }
